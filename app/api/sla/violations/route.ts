...
/**
 * GET /api/sla/violations - Get SLA violations with role-based filtering
 * 
 * Query parameters:
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Get violations with role-based filtering
    const violations = await slaService.getSLAViolations(filters, currentUser.id);
